...
exports.toPropValue = void 0;
// ブレークポイント
const BREAKPOINTS = {
    sm: '640px',
    md: '768px',
    lg: '1024px',
    xl: '1280px', // 1280px以上(デスクトップ)
};
/**
 ...
 */
function toPropValue(propKey, prop, theme) {
    if (prop === undefined)
        return undefined;
    // レスポンシブなプロパティかどうかチェック
 ...
 * @returns CSSプロパティの値
 */
function toThemeValueIfNeeded(propKey, value, theme) {
    if (theme &&
        theme.space &&
...
function isResponsivePropType(prop) {
    return (prop &&
        (prop.base !== undefined ||
            prop.sm !== undefined ||
            prop.md !== undefined ||
