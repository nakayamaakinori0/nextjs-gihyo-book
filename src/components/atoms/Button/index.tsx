...
const Button = styled.button<ButtonProps>`
  ${({ variant, color, backgroundColor, pseudoClass, theme }) => {
    ...
    if (variant && variants[variant]) {
      ...
      !backgroundColor && styles.push(toPropValue('backgroundColor', variants[variant].pseudoClass.hover.backgroundColor, theme))
      !pseudoClass && styles.push(`&:hover { ${toPropValue('background-color', variants[variant].pseudoClass.hover.backgroundColor, theme)} }`)
      return styles.join('\n')
    }
  }}
